defmodule AFW.Settlement.Hub do
  ...
  def handle_cast({:submit, attrs}, state) do
    ...
    Phoenix.PubSub.broadcast(AFW.PubSub, "agents", {:settlement_optimistic, event.agent_id, State.settlement_summary(event.agent_id)})
  ...
  defp schedule(:deferred), do: Process.send_after(self(), {:settle, :deferred}, @deferred_interval)
