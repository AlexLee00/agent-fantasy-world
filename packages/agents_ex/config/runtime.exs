...
config :afw,
  ...
  tier4_node_backend: System.get_env("TIER4_NODE_BACKEND", "afw-basic"),
  tier4_node_port: String.to_integer(System.get_env("TIER4_NODE_PORT", "18791")),
  tier4_node_public_url: System.get_env("TIER4_NODE_PUBLIC_URL", ""),
